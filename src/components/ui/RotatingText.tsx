...
export const RotatingText = forwardRef<RotatingTextRef, RotatingTextProps>(
  (
    ...
    return (
      <motion.span
        className={cn("flex flex-wrap items-center justify-center whitespace-pre-wrap relative", mainClassName)}
        {...rest}
        layout
        transition={transition}
      >
        ...
        <AnimatePresence mode={animatePresenceMode} initial={animatePresenceInitial}>
          <motion.span
            ...
            className="flex flex-wrap items-center justify-center whitespace-pre-wrap relative"
            layout
            aria-hidden="true"
          >
